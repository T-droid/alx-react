                            ...
                            {listNotifications && listNotifications.length > 0 ? (
                                <>
                                    ...
                                    {listNotifications.map((notification) => (
                                        <NotificationItem key={notification.id} type={notification.type} value={notification.value} html={notification.html} id={notification.id} markAsRead={markNotificationAsRead}/>
                                    ))}
                                </>                            
                            ) : (
